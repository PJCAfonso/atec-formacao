...
wget --no-hsts -O ~/start-xfce https://github.com/PJCAfonso/atec-formacao/blob/master/X-Kali-wsl/start-xfce
wget --no-hsts -O ~/.xinitrc https://github.com/PJCAfonso/atec-formacao/blob/master/X-Kali-wsl/.xinitrc
...
sudo wget --no-hsts -O /etc/xdg/xfce4/panel/default.xml https://github.com/PJCAfonso/atec-formacao/blob/master/X-Kali-wsl/default.xml
sudo wget --no-hsts -O /etc/xdg/xfce4/xfconf/xfce-perchannel-xml/xfce4-session.xml https://github.com/PJCAfonso/atec-formacao/blob/master/X-Kali-wsl/xfce4-session.xml
